...
#define _AST_NODE_ERROR_                                                       \
    std::cerr << "Abort due to node cast error."                               \
              ...
              << std::endl;                                                    \
    std::abort();
// NOTE: use std::string instead of strcmp to compare strings, 注意使用这里的接口
...
ASTNode *AST::transform_node_iter(syntax_tree_node *n) {
    ...
    */
    if (_STR_EQ(n->name, "program")) {
        ...
        // TODO: fill the fields of ASTFunDeclaration
    
        return node;
    } else if (_STR_EQ(n->name, "param")) {
        auto node = new ASTParam();
        // TODO: fill the fields of ASTParam
        return node;
        ...
        if (n->children[1]->children_num == 2) {
            ...
            // TODO: fill the fields of ASTCompoundStmt with local declarations
        }
        
        // statement list
        if (n->children[2]->children_num == 2) {
            // flatten statement-list
            // TODO: fill the fields of ASTCompoundStmt with statement list
        }
        return node;
        ...
        // TODO: fill the fields of ASTExpressionStmt
        return node;
    } else if (_STR_EQ(n->name, "selection-stmt")) {
        auto node = new ASTSelectionStmt();
        // TODO: fill the fields of ASTSelectionStmt
        // expresstion
        ...
        // TODO: fill the fields of ASTIterationStmt

        return node;
    } else if (_STR_EQ(n->name, "return-stmt")) {
        auto node = new ASTReturnStmt();

        // TODO: fill the fields of ASTReturnStmt
        ...
        if (_STR_EQ(name, "expression") || _STR_EQ(name, "var") ||
            ...
            if (_STR_EQ(name, "integer")) {
                // TODO: fill the fields of ASTNum
        ...
        // TODO: fill the fields of ASTCall
...
void ASTVarDeclaration::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
void ASTFunDeclaration::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
void ASTParam::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
void ASTCompoundStmt::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
void ASTExpressionStmt::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
void ASTSelectionStmt::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
void ASTIterationStmt::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
void ASTReturnStmt::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
void ASTAssignExpression::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
void ASTSimpleExpression::accept(ASTVisitor &visitor) { return visitor.visit(*this); }
